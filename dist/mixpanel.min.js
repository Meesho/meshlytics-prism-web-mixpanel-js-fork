...
this.j=b.G||c.bind(pa.error,pa);this.Oa=new qa(a,{h:this.h});this.ma=b.ma||q;this.D=[]}function qa(a,b){b=b||{};this.I=a;this.h=b.h||window.localStorage;this.Eb=b.Eb||100;this.Tb=b.Tb||2E3}function V(){this.Bb="submit"}function L(){this.Bb="click"}function D(){}function ra(a){var b=Fa,d=a.split("."),d=d[d.length-1];if(4<d.length||"com"===d||"org"===d)b=Ga;return(a=a.match(b))?a[0]:""}function ea(a){var b=Math.random().toString(36).substring(2,10)+Math.random().toString(36).substring(2,10);return a?
b.substring(0,a):b}function W(a,b){if(fa!==q&&!b)return fa;var d=l;try{var a=a||window.localStorage,c="__mplss_"+ea(8);a.setItem(c,"xyz");"xyz"!==a.getItem(c)&&(d=F);a.removeItem(c)}catch(f){d=F}return fa=d}function ga(a){return{log:ha(p.log,a),error:ha(p.error,a),F:ha(p.F,a)}}function ha(a,b){return function(){arguments[0]="["+b+"] "+arguments[0];return a.apply(p,arguments)}}function Ha(a,b){sa(l,a,b)}function Ia(a,b){sa(F,a,b)}function Ja(a,b){return"1"===X(b).get(Y(a,b))}function ta(a,b){if(Ka(b))return p.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'),
l;var d="0"===X(b).get(Y(a,b));d&&p.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data.");return d}function P(a){return ia(a,function(a){return this.c(a)})}function I(a){return ia(a,function(a){return this.v(a)})}function M(a){return ia(a,function(a){return this.v(a)})}function La(a,b){b=b||{};X(b).remove(Y(a,b),!!b.lb,b.jb)}function X(a){a=a||{};return"localStorage"===a.Db?c.localStorage:c.cookie}function Y(a,b){b=b||{};return(b.Cb||Ma)+a}function Ka(a){if(a&&
a.sb)return F;var a=a&&a.window||A,b=a.navigator||{},d=F;c.a([b.doNotTrack,b.msDoNotTrack,a.doNotTrack],function(a){c.i([l,1,"1","yes"],a)&&(d=l)});return d}function sa(a,b,d){!c.Na(b)||!b.length?p.error("gdpr."+(a?"optIn":"optOut")+" called with an invalid token"):(d=d||{},X(d).set(Y(b,d),a?1:0,c.xb(d.kb)?d.kb:q,!!d.lb,!!d.Mc,!!d.nc,d.jb),d.m&&a&&d.m(d.ad||"$opt_in",d.bd,{send_immediately:l}))}function ia(a,b){return function(){var d=F;try{var c=b.call(this,"token"),f=b.call(this,"ignore_dnt"),g=
...
d){var c,f=0;for(c=0;c<d.length;c++)f|=g[c]<<8*c;return b^f}var b,c,g=[],e=0;for(b=0;b<z.length;b++)c=z.charCodeAt(b),g.unshift(c&255),4<=g.length&&(e=a(e,g),g=[]);0<g.length&&(e=a(e,g));return e.toString(16)}function b(){for(var a=1*new Date,b=0;a==1*new Date;)b++;return a.toString(16)+b.toString(16)}return function(){var d=($.height*$.width).toString(16);return b()+"-"+Math.random().toString(16).replace(".","")+"-"+a()+"-"+d+"-"+b()}}();var ya="ahrefsbot,baiduspider,bingbot,bingpreview,facebookexternal,petalbot,pinterest,screaming frog,yahoo! slurp,yandexbot,adsbot-google,apis-google,duplexweb-google,feedfetcher-google,google favicon,google web preview,google-read-aloud,googlebot,googleweblight,mediapartners-google,storebot-google".split(",");
...
"_blank"===b.target;c.href=b.href;c.zb||a.preventDefault()};L.prototype.Ba=function(a,b){b.zb||setTimeout(function(){window.location=b.href},0)};c.vb(V,D);V.prototype.Ia=function(a,b,c){c.element=b;a.preventDefault()};V.prototype.Ba=function(a,b){setTimeout(function(){b.element.submit()},0)};var Oa=ga("lock");qa.prototype.Wa=function(a,b,c){function n(){i.setItem(t,"1");try{a()}finally{i.removeItem(t),i.getItem(p)===j&&i.removeItem(p),i.getItem(m)===j&&i.removeItem(m)}}function f(){i.setItem(m,j);
e(g,function(){i.getItem(m)===j?n():h(function(){i.getItem(p)!==j?f():e(function(){return!i.getItem(t)},n)})})}function g(){var a=i.getItem(p);if(a&&a!==j)return F;i.setItem(p,j);if(i.getItem(p)===j)return l;if(!W(i,l))throw Error("localStorage support dropped while acquiring lock");return F}function e(a,b){a()?b():h(function(){e(a,b)})}function h(a){(new Date).getTime()-o>u?(Oa.error("Timeout waiting for mutex on "+r+"; clearing lock. ["+j+"]"),i.removeItem(t),i.removeItem(p),f()):setTimeout(function(){try{a()}catch(c){b&&
b(c)}},v*(Math.random()+0.1))}!c&&"function"!==typeof b&&(c=b,b=q);var j=c||(new Date).getTime()+"|"+Math.random(),o=(new Date).getTime(),r=this.I,v=this.Eb,u=this.Tb,i=this.h,m=r+":X",p=r+":Y",t=r+":Z";try{if(W(i,l))f();else throw Error("localStorage support check failed");}catch(s){b&&b(s)}};var pa=ga("batch");H.prototype.Ha=function(a,b,d){var n={id:ea(),flushAfter:(new Date).getTime()+2*b,payload:a};this.Oa.Wa(c.bind(function(){var b;try{var c=this.X();c.push(n);(b=this.Sa(c))&&this.D.push(n)}catch(e){this.j("Error enqueueing item",
...
this.flush();else if(c.e(e)&&e.L&&(500<=e.L.status||429===e.L.status||"timeout"===e.error)){var h=2*this.ia,j=e.L.responseHeaders;if(j){var o=j["Retry-After"];o&&(h=1E3*parseInt(o,10)||h)}h=Math.min(6E5,h);this.j("Error; retry in "+h+" ms");this.Kb(h)}else if(c.e(e)&&e.L&&413===e.L.status)if(1<f.length){var m=Math.max(1,Math.floor(n/2));this.S=Math.min(this.S,m,f.length-1);this.j("413 response; reducing batch size to "+this.S);this.Y()}else this.j("Single-event request too large; dropping",f),this.Jb(),
g=l;else g=l;g&&this.W.Hc(c.map(f,function(a){return a.id}),c.bind(function(a){a?(this.Ea=0,this.flush()):(this.j("Failed to remove items from queue"),5<++this.Ea?(this.j("Too many queue failures; disabling batching system."),this.Xc()):this.Y())},this))}catch(p){this.j("Error handling API response",p),this.Y()}},this),j={method:"POST",ac:l,xc:l,Ub:b};if(a.Xb)j.Ua="sendBeacon";S.log("MIXPANEL REQUEST:",e);this.Nc(e,j,h)}}}catch(o){this.j("Error flushing request queue",o),this.Y()}};C.prototype.j=
function(a,b){S.error.apply(S.error,arguments);if(this.G)try{b instanceof Error||(b=Error(a)),this.G(a,b)}catch(c){S.error(c)}};var Ma="__mp_opt_in_out_",B={Mb:function(a,b){var d={},e={};c.e(a)?c.a(a,function(a,b){this.z(b)||(e[b]=a)},this):e[a]=b;d.$set=e;return d},Yb:function(a){var b={},d=[];c.isArray(a)||(a=[a]);c.a(a,function(a){this.z(a)||d.push(a)},this);b.$unset=d;return b},Pb:function(a,b){var d={},e={};c.e(a)?c.a(a,function(a,b){this.z(b)||(e[b]=a)},this):e[a]=b;d.$set_once=e;return d},
Wb:function(a,b){var d={},e={};c.e(a)?c.a(a,function(a,b){this.z(b)||(e[b]=c.isArray(a)?a:[a])},this):e[a]=c.isArray(b)?b:[b];d.$union=e;return d},jc:function(a,b){var d={},e={};c.e(a)?c.a(a,function(a,b){this.z(b)||(e[b]=a)},this):e[a]=b;d.$append=e;return d},Hb:function(a,b){var d={},e={};c.e(a)?c.a(a,function(a,b){this.z(b)||(e[b]=a)},this):e[a]=b;d.$remove=e;return d},od:function(){return{$delete:""}}};c.extend(s.prototype,B);s.prototype.R=function(a,b,c){this.d=a;this.xa=b;this.wa=c};s.prototype.set=
M(function(a,b,d){var e=this.Mb(a,b);c.e(a)&&(d=b);return this.k(e,d)});s.prototype.na=M(function(a,b,d){var e=this.Pb(a,b);c.e(a)&&(d=b);return this.k(e,d)});s.prototype.qa=M(function(a,b){return this.k(this.Yb(a),b)});s.prototype.Z=M(function(a,b,d){c.e(a)&&(d=b);return this.k(this.Wb(a,b),d)});s.prototype["delete"]=M(function(a){return this.k({$delete:""},a)});s.prototype.remove=M(function(a,b,c){return this.k(this.Hb(a,b),c)});s.prototype.k=function(a,b){a.$group_key=this.xa;a.$group_id=this.wa;
a.$token=this.v("token");return this.d.Aa({type:"groups",data:c.Ga(a),C:this.v("api_host")+"/groups/",Ca:this.d.p.wc},b)};s.prototype.z=function(a){return"$group_key"===a||"$group_id"===a};s.prototype.v=function(a){return this.d.c(a)};s.prototype.toString=function(){return this.d.toString()+".group."+this.xa+"."+this.wa};s.prototype.remove=s.prototype.remove;s.prototype.set=s.prototype.set;s.prototype.set_once=s.prototype.na;s.prototype.union=s.prototype.Z;s.prototype.unset=s.prototype.qa;s.prototype.toString=
s.prototype.toString;c.extend(i.prototype,B);i.prototype.R=function(a){this.d=a};i.prototype.set=I(function(a,b,d){var e=this.Mb(a,b);c.e(a)&&(d=b);this.v("save_referrer")&&this.d.persistence.Va(document.referrer);e.$set=c.extend({},c.info.Gc(),this.d.persistence.vc(),e.$set);return this.k(e,d)});i.prototype.na=I(function(a,b,d){var e=this.Pb(a,b);c.e(a)&&(d=b);return this.k(e,d)});i.prototype.qa=I(function(a,b){return this.k(this.Yb(a),b)});i.prototype.ub=I(function(a,b,d){var e={},f={};c.e(a)?(c.a(a,
function(a,b){this.z(b)||(isNaN(parseFloat(a))?p.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):f[b]=a)},this),d=b):(c.g(b)&&(b=1),f[a]=b);e.$add=f;return this.k(e,d)});i.prototype.append=I(function(a,b,d){c.e(a)&&(d=b);return this.k(this.jc(a,b),d)});i.prototype.remove=I(function(a,b,d){c.e(a)&&(d=b);return this.k(this.Hb(a,b),d)});i.prototype.Z=I(function(a,b,d){c.e(a)&&(d=b);return this.k(this.Wb(a,b),d)});i.prototype.cd=I(function(a,b,d){if(!c.xb(a)&&(a=
parseFloat(a),isNaN(a))){p.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",c.extend({$amount:a},b),d)});i.prototype.hb=function(a){return this.set("$transactions",[],a)};i.prototype.ob=function(){if(this.ya())return this.k({$delete:this.d.H()});p.error("mixpanel.people.delete_user() requires you to call identify() first")};i.prototype.toString=function(){return this.d.toString()+".people"};i.prototype.k=function(a,b){a.$token=
this.v("token");a.$distinct_id=this.d.H();var d=this.d.s("$device_id"),e=this.d.s("$user_id"),f=this.d.s("$had_persisted_distinct_id");d&&(a.$device_id=d);e&&(a.$user_id=e);f&&(a.$had_persisted_distinct_id=f);d=c.Ga(a);return!this.ya()?(this.ec(a),c.g(b)||(this.v("verbose")?b({status:-1,error:q}):b(-1)),c.truncate(d,255)):this.d.Aa({type:"people",data:d,C:this.v("api_host")+"/engage/",Ca:this.d.p.Fc},b)};i.prototype.v=function(a){return this.d.c(a)};i.prototype.ya=function(){return this.d.O.rb===
l};i.prototype.ec=function(a){"$set"in a?this.d.persistence.q("$set",a):"$set_once"in a?this.d.persistence.q("$set_once",a):"$unset"in a?this.d.persistence.q("$unset",a):"$add"in a?this.d.persistence.q("$add",a):"$append"in a?this.d.persistence.q("$append",a):"$remove"in a?this.d.persistence.q("$remove",a):"$union"in a?this.d.persistence.q("$union",a):p.error("Invalid call to _enqueue():",a)};i.prototype.P=function(a,b,d,e){var f=this,g=c.extend({},this.d.persistence.ca(a)),i=g;!c.g(g)&&c.e(g)&&!c.ka(g)&&
(f.d.persistence.w(a,g),e&&(i=e(g)),b.call(f,i,function(b,e){0===b&&f.d.persistence.q(a,g);c.g(d)||d(b,e)}))};i.prototype.fc=function(a,b,d,e,f,g,i){var h=this,j=this.d.persistence.ca("$append"),o=this.d.persistence.ca("$remove");this.P("$set",this.set,a);this.P("$set_once",this.na,e);this.P("$unset",this.qa,g,function(a){return c.keys(a)});this.P("$add",this.ub,b);this.P("$union",this.Z,f);if(!c.g(j)&&c.isArray(j)&&j.length){for(var m,a=function(a,b){0===a&&h.d.persistence.q("$append",m);c.g(d)||
d(a,b)},b=j.length-1;0<=b;b--)m=j.pop(),c.ka(m)||h.append(m,a);h.d.persistence.save()}if(!c.g(o)&&c.isArray(o)&&o.length){for(var v,j=function(a,b){0===a&&h.d.persistence.q("$remove",v);c.g(i)||i(a,b)},a=o.length-1;0<=a;a--)v=o.pop(),c.ka(v)||h.remove(v,j);h.d.persistence.save()}};i.prototype.z=function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};i.prototype.set=i.prototype.set;i.prototype.set_once=i.prototype.na;i.prototype.unset=
i.prototype.qa;i.prototype.increment=i.prototype.ub;i.prototype.append=i.prototype.append;i.prototype.remove=i.prototype.remove;i.prototype.union=i.prototype.Z;i.prototype.track_charge=i.prototype.cd;i.prototype.clear_charges=i.prototype.hb;i.prototype.delete_user=i.prototype.ob;i.prototype.toString=i.prototype.toString;var Pa="__mps,__mpso,__mpus,__mpa,__mpap,__mpr,__mpu,$people_distinct_id,__alias,__timers".split(",");m.prototype.V=function(){var a={};c.a(this.props,function(b,d){c.tb(Pa,d)||(a[d]=
b)});return a};m.prototype.load=function(){if(!this.disabled){var a=this.h.parse(this.name);a&&(this.props=c.extend({},a))}};m.prototype.kd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.h.parse(d),this.h.remove(d),this.h.remove(d,l),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.h.parse(d)))this.h.remove(d),this.h.remove(d,l),this.u(b);this.h===c.localStorage&&(b=c.cookie.parse(this.name),
c.cookie.remove(this.name),c.cookie.remove(this.name,l),b&&this.u(b))};m.prototype.save=function(){this.disabled||this.h.set(this.name,c.aa(this.props),this.Ja,this.Fa,this.Lb,this.mb,this.fa)};m.prototype.remove=function(){this.h.remove(this.name,F,this.fa);this.h.remove(this.name,l,this.fa)};m.prototype.clear=function(){this.remove();this.props={}};m.prototype.u=function(a,b,d){return c.e(a)?("undefined"===typeof b&&(b="None"),this.Ja="undefined"===typeof d?this.nb:d,c.a(a,function(a,c){if(!this.props.hasOwnProperty(c)||
this.props[c]===b)this.props[c]=a},this),this.save(),l):F};m.prototype.o=function(a,b){return c.e(a)?(this.Ja="undefined"===typeof b?this.nb:b,c.extend(this.props,a),this.save(),l):F};m.prototype.$=function(a){a in this.props&&(delete this.props[a],this.save())};m.prototype.jd=function(){if(!this.gb)this.u(c.info.mc()),this.gb=l};m.prototype.$b=function(a){this.o(c.info.Lc(a))};m.prototype.Va=function(a){this.u({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.Fb(a)||"$direct"},"")};
m.prototype.vc=function(){return c.pa({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};m.prototype.Zb=function(a){this.nb=this.Ja=a.cookie_expiration;this.Ob(a.disable_persistence);this.Qc(a.cookie_domain);this.Rc(a.cross_site_cookie);this.Sc(a.cross_subdomain_cookie);this.Vc(a.secure_cookie)};m.prototype.Ob=function(a){(this.disabled=a)?this.remove():this.save()};m.prototype.Qc=function(a){if(a!==this.fa)this.remove(),this.fa=a,this.save()};
m.prototype.Rc=function(a){if(a!==this.mb)this.mb=a,this.remove(),this.save()};m.prototype.Sc=function(a){if(a!==this.Fa)this.Fa=a,this.remove(),this.save()};m.prototype.tc=function(){return this.Fa};m.prototype.Vc=function(a){if(a!==this.Lb)this.Lb=a?l:F,this.remove(),this.save()};m.prototype.q=function(a,b){var d=this.va(a),e=b[a],f=this.B("$set"),g=this.B("$set_once"),i=this.B("$unset"),h=this.B("$add"),j=this.B("$union"),o=this.B("$remove",[]),m=this.B("$append",[]);"__mps"===d?(c.extend(f,e),
this.w("$add",e),this.w("$union",e),this.w("$unset",e)):"__mpso"===d?(c.a(e,function(a,b){b in g||(g[b]=a)}),this.w("$unset",e)):"__mpus"===d?c.a(e,function(a){c.a([f,g,h,j],function(b){a in b&&delete b[a]});c.a(m,function(b){a in b&&delete b[a]});i[a]=l}):"__mpa"===d?(c.a(e,function(a,b){b in f?f[b]+=a:(b in h||(h[b]=0),h[b]+=a)},this),this.w("$unset",e)):"__mpu"===d?(c.a(e,function(a,b){c.isArray(a)&&(b in j||(j[b]=[]),j[b]=j[b].concat(a))}),this.w("$unset",e)):"__mpr"===d?(o.push(e),this.w("$append",
e)):"__mpap"===d&&(m.push(e),this.w("$unset",e));p.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");p.log(b);this.save()};m.prototype.w=function(a,b){var d=this.ca(a);c.g(d)||(c.a(b,function(b,e){"$append"===a||"$remove"===a?c.a(d,function(a){a[e]===b&&delete a[e]}):delete d[e]},this),this.save())};m.prototype.va=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$unset"===a)return"__mpus";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";if("$remove"===
a)return"__mpr";if("$union"===a)return"__mpu";p.error("Invalid queue:",a)};m.prototype.ca=function(a){return this.props[this.va(a)]};m.prototype.B=function(a,b){var d=this.va(a),b=c.g(b)?{}:b;return this.props[d]||(this.props[d]=b)};m.prototype.Tc=function(a){var b=this.props.__timers||{};b[a]=(new Date).getTime();this.props.__timers=b;this.save()};m.prototype.Ic=function(a){var b=(this.props.__timers||{})[a];c.g(b)||(delete this.props.__timers[a],this.save());return b};var ca,w,N=A.XMLHttpRequest&&
"withCredentials"in new XMLHttpRequest,ma=!N&&-1===z.indexOf("MSIE")&&-1===z.indexOf("Mozilla"),T=q;E.sendBeacon&&(T=function(){return E.sendBeacon.apply(E,arguments)});var za={api_host:"https://api-js.mixpanel.com",api_method:"POST",api_transport:"XHR",api_payload_format:"base64",app_host:"https://mixpanel.com",cdn:"https://cdn.mxpnl.com",cross_site_cookie:F,cross_subdomain_cookie:l,error_reporter:O,persistence:"cookie",persistence_name:"",cookie_domain:"",cookie_name:"",loaded:O,store_google:l,
save_referrer:l,test:F,verbose:F,img:F,debug:F,track_links_timeout:300,cookie_expiration:365,upgrade:F,disable_persistence:F,disable_cookie:F,secure_cookie:F,ip:l,opt_out_tracking_by_default:F,opt_out_persistence_by_default:F,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:q,property_blacklist:[],xhr_headers:{},ignore_dnt:F,batch_requests:l,batch_size:50,batch_flush_interval_ms:5E3,batch_request_timeout_ms:9E4,batch_autostart:l,hooks:{}},la=F;e.prototype.La=function(a,
b,d){if(c.g(d))this.l("You must name your new library: init(token, config, name)");else if("mixpanel"===d)this.l("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");else return a=U(a,b,d),w[d]=a,a.da(),a};p.log("here in 18th oct branch mixpanel core.js in src");e.prototype.R=function(a,b,d){p.log("here in _init func token: ",a);var e=new Blob(["data="+encodeURIComponent({token:a,name:"shelly"})],{type:"application/x-www-form-urlencoded"});T("https://events-web-test.meeshoapi.com",
e);p.log("here url is: ","https://events-web-test.meeshoapi.com");b=b||{};this.__loaded=l;this.config={};e={};"api_payload_format"in b||(b.api_host||za.api_host).match(/\.mixpanel\.com$/)&&(e.api_payload_format="json");this.Nb(c.extend({},za,e,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=O;this.sa=[];this.ta=[];this.ra=[];this.O={disable_all_events:F,identify_called:F};this.p={};if(this.N=this.c("batch_requests"))if(!c.localStorage.la(l)||!N)this.N=F,p.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support");
else if(this.yc(),T&&A.addEventListener){var f=c.bind(function(){this.p.ha.oa||this.p.ha.flush({Xb:l})},this);A.addEventListener("pagehide",function(a){a.persisted&&f()});A.addEventListener("visibilitychange",function(){"hidden"===t.visibilityState&&f()})}this.persistence=this.cookie=new m(this.config);this.K={};this.gc();a=c.Xa();this.H()||this.u({distinct_id:a,$device_id:a},"")};e.prototype.da=function(){this.c("loaded")(this);this.eb()};e.prototype.eb=function(){this.persistence.$b(t.referrer);
this.c("store_google")&&this.persistence.jd();this.c("save_referrer")&&this.persistence.Va(t.referrer)};e.prototype.dc=function(){c.a(this.sa,function(a){this.za.apply(this,a)},this);this.U()||c.a(this.ta,function(a){this.k.apply(this,a)},this);delete this.sa;delete this.ta};e.prototype.za=function(a,b){if(this.c("img"))return this.l("You can't use DOM tracking functions with img = true."),F;if(!la)return this.sa.push([a,b]),F;var c=(new a).La(this);return c.m.apply(c,b)};e.prototype.ab=function(a,
b){if(c.g(a))return q;if(N)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return f};e.prototype.k=function(a,b,d,e){var f=l;if(ma)return this.ta.push(arguments),f;var g={method:this.c("api_method"),Ua:this.c("api_transport"),ac:this.c("verbose")},i=q;if(!e&&(c.Ma(d)||"string"===typeof d))e=d,d=q;d=c.extend(g,d||{});if(!N)d.method="GET";var g="POST"===d.method,h=T&&g&&"sendbeacon"===d.Ua.toLowerCase(),
j=d.ac;b.verbose&&(j=l);this.c("test")&&(b.test=1);j&&(b.verbose=1);this.c("img")&&(b.img=1);if(!N)if(e)b.callback=e;else if(j||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();g&&(i="data="+encodeURIComponent(b.data),delete b.data);var a=a+("?"+c.bc(b)),o=this;if("img"in b)i=t.createElement("img"),i.src=a,t.body.appendChild(i);else if(h){try{f=T(a,i)}catch(m){o.l(m),f=F}try{e&&e(f?1:0)}catch(p){o.l(p)}}else if(N)try{var u=new XMLHttpRequest;u.open(d.method,
a,l);var s=this.c("xhr_headers");g&&(s["Content-Type"]="application/x-www-form-urlencoded");c.a(s,function(a,b){u.setRequestHeader(b,a)});if(d.Ub&&"undefined"!==typeof u.timeout){u.timeout=d.Ub;var w=(new Date).getTime()}u.withCredentials=l;u.onreadystatechange=function(){if(4===u.readyState)if(200===u.status){if(e)if(j){var a;try{a=c.M(u.responseText)}catch(b){if(o.l(b),d.xc)a=u.responseText;else return}e(a)}else e(Number(u.responseText))}else a=u.timeout&&!u.status&&(new Date).getTime()-w>=u.timeout?
"timeout":"Bad HTTP status: "+u.status+" "+u.statusText,o.l(a),e&&(j?e({status:0,error:a,L:u}):e(0))};u.send(i)}catch(x){o.l(x),f=F}else i=t.createElement("script"),i.type="text/javascript",i.async=l,i.defer=l,i.src=a,s=t.getElementsByTagName("script")[0],s.parentNode.insertBefore(i,s);return f};e.prototype.ua=function(a){function b(a,b){c.a(a,function(a){if(c.isArray(a[0])){var d=b;c.a(a,function(a){d=d[a[0]].apply(d,a.slice(1))})}else this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],f=[],g=[];c.a(a,
...
this.persistence.Zb(this.config),J=J||this.c("debug")};e.prototype.c=function(a){return this.config[a]};e.prototype.cb=function(a){var b=(this.config.hooks[a]||Ea).apply(this,K.call(arguments,1));"undefined"===typeof b&&(this.l(a+" hook did not return a value"),b=q);return b};e.prototype.s=function(a){return this.persistence.props[a]};e.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};e.prototype.$a=function(a){return c.wb(z)||this.O.oc||c.tb(this.ra,
a)};e.prototype.gc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.la()&&(!this.ja()&&this.ja({persistence_type:"cookie"})&&this.Ab({enable_persistence:F}),!this.U()&&this.U({persistence_type:"cookie"})&&this.Pa({clear_persistence:F}),this.ib({persistence_type:"cookie",enable_persistence:F}));if(this.U())this.ba({clear_persistence:l});else if(!this.ja()&&(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout")))c.cookie.remove("mp_optout"),this.Pa({clear_persistence:this.c("opt_out_persistence_by_default")})};
e.prototype.ba=function(a){if(a&&a.clear_persistence)a=l;else if(a&&a.enable_persistence)a=F;else return;!this.c("disable_persistence")&&this.persistence.disabled!==a&&this.persistence.Ob(a);a&&c.a(this.p,function(a){a.clear()})};e.prototype.Q=function(a,b){b=c.extend({track:c.bind(this.m,this),persistence_type:this.c("opt_out_tracking_persistence_type"),cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_site_cookie:this.c("cross_site_cookie"),
...
a);this.Q(Ha,a);this.ba(a)};e.prototype.Pa=function(a){a=c.extend({clear_persistence:l,delete_user:l},a);a.delete_user&&this.people&&this.people.ya()&&(this.people.ob(),this.people.hb());this.Q(Ia,a);this.ba(a)};e.prototype.ja=function(a){return this.Q(Ja,a)};e.prototype.U=function(a){return this.Q(ta,a)};e.prototype.ib=function(a){a=c.extend({enable_persistence:l},a);this.Q(La,a);this.ba(a)};e.prototype.l=function(a,b){p.error.apply(p.error,arguments);try{!b&&!(a instanceof Error)&&(a=Error(a)),
this.c("error_reporter")(a,b)}catch(c){p.error(c)}};e.prototype.init=e.prototype.La;e.prototype.reset=e.prototype.reset;e.prototype.disable=e.prototype.disable;e.prototype.time_event=e.prototype.$c;e.prototype.track=e.prototype.m;e.prototype.track_links=e.prototype.ed;e.prototype.track_forms=e.prototype.dd;e.prototype.track_pageview=e.prototype.fd;e.prototype.register=e.prototype.o;e.prototype.register_once=e.prototype.u;e.prototype.unregister=e.prototype.$;e.prototype.identify=e.prototype.Ka;e.prototype.alias=
...
e.prototype.uc;e.prototype.set_group=e.prototype.Uc;e.prototype.add_group=e.prototype.hc;e.prototype.remove_group=e.prototype.Jc;e.prototype.track_with_groups=e.prototype.gd;e.prototype.start_batch_senders=e.prototype.Rb;e.prototype.stop_batch_senders=e.prototype.Sb;m.prototype.properties=m.prototype.V;m.prototype.update_search_keyword=m.prototype.$b;m.prototype.update_referrer_info=m.prototype.Va;m.prototype.get_cross_subdomain=m.prototype.tc;m.prototype.clear=m.prototype.clear;var G={};(function(){ca=
1;w=A.mixpanel;c.g(w)?p.F('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):w.__loaded||w.config&&w.persistence?p.F("The Mixpanel library has already been downloaded at least once. Ensure that the Mixpanel code snippet only appears once on the page (and is not double-loaded by a tag manager) in order to avoid errors."):1.1>(w.__SV||0)?p.F("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet."):
(c.a(w._i,function(a){a&&c.isArray(a)&&(G[a[a.length-1]]=U.apply(this,a))}),Ba(),w.init(),c.a(G,function(a){a.da()}),Aa())})()})();
})();
